...
function FlightPrice() {
  ...
  return (
    ...
    >
      <h1 className="font-semibold text-white text-5xl font-mono mb-8">
        Flight Price Prediction
      </h1>

      <form
        onSubmit={handleSubmit}
        className="bg-white/10 shadow-md rounded-lg p-8 w-full max-w-lg space-y-6"
      >
        {/* Airline Field */}
        <div className="space-y-2 w-full">
          <label className="block text-sm font-bold text-white">Airline</label>
          <select
            name="airline"
        ...
        {/* Stops Field */}
        <div className="space-y-2 w-full">
          <label className="block text-sm font-bold text-white">Stops</label>
          <select
            name="stops"
        ...
        {/* Class Field */}
        <div className="space-y-2 w-full">
          <label className="block text-sm font-bold text-white">Class</label>
          <select
            name="class"
